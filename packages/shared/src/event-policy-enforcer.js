 ...
 */
export function validateEventNaming(eventType) {
 ...
 */
export function validateEventPolicy(eventType, metadata) {
    const errors = [];
    const warnings = [];
 ...
 */
export function enforceEventPolicy(eventType, metadata) {
 ...
 */
export function calculateRetentionDeadline(eventType, occurredAt) {
 ...
 */
export function shouldArchiveEvent(eventType, occurredAt) {
    const retentionDays = getRetentionPolicy(eventType);
 ...
 */
export function shouldPurgeEvent(eventType, occurredAt) {
    const retentionDays = getRetentionPolicy(eventType);
 ...
 */
export function addRetentionPolicy(eventType, retentionDays) {
    if (retentionDays < 0) {
 ...
 */
export function addDlqPolicy(eventType, enabled, maxRetryAttempts, backoffMs) {
...
//# sourceMappingURL=event-policy-enforcer.js.map